...
const std::string CURRENCY_UNIT = "PHO"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    COIN_KVB,     //!< Use whole-coin/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::COIN_KVB) const;
