    ...
    : TestingSetup{CBaseChainParams::REGTEST, extra_args, coins_db_in_memory, block_tree_db_in_memory}
{
...

    {
        ...
        // Photon regtest deterministic COINBASE_MATURITY-block-chain tip hash.
        // This deliberately fails if consensus/test fixture parameters drift.
        if (tip_hash != "5ab9337ea87575082e232178dce44867587cd7faf3e505252dfad6e107f4fad6") {
