...
struct DersigInactiveSetup : public TestChain100Setup {
    DersigInactiveSetup()
        : TestChain100Setup{CBaseChainParams::REGTEST, {"-testactivationheight=dersig@999999"}} {}
};
...
BOOST_FIXTURE_TEST_CASE(tx_mempool_block_doublespend, DersigInactiveSetup)
{
...
BOOST_FIXTURE_TEST_CASE(checkinputs_test, DersigInactiveSetup)
{
