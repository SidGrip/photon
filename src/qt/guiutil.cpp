...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("photon://", Qt::CaseInsensitive))
    {
        uri.replace(0, 9, "photon:");
    }
...
{
    QString ret = QString("photon:%1").arg(info.address);
    int paramCount = 0;
...
fs::path static StartupShortcutPath()
{
    ...
    return GetSpecialFolderPath(CSIDL_STARTUP) / strprintf("Photon (%s).lnk", chain);
}
