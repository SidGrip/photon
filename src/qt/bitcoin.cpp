...
static const char* qt_argv = "photon-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success) {
        ...
        // photon: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse photon.conf, determine network, switch to network specific
    ...
    // photon: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
