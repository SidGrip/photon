...
static constexpr auto MAX_DIGITS_PHO = 16;
...
{
    switch (unit) {
    case Unit::BTC: return QString("PHO");
    case Unit::mBTC: return QString("mPHO");
    case Unit::uBTC: return QString::fromUtf8("µPHO");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Photons");
    case Unit::mBTC: return QString("Milli-Photons (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Photons (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Satoshi (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000 PHO)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
QString BitcoinUnits::format(Unit unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool justify)
{
    ...
    if (justify) {
        quotient_str = quotient_str.rightJustified(MAX_DIGITS_PHO - num_decimals, ' ');
    }
