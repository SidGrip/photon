...
ADDRESS_BCRT1_UNSPENDABLE = 'rpho1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqmsqlzs'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(rpho1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqmsqlzs)#amecmc09'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'rpho1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq60p7pk'
...
# Photon regtest/mainnet use xpub/xprv version bytes with Blake Base58Check
# (inherited Blakecoin-family Base58 identity).
...
def create_deterministic_address_bcrt1_p2tr_op_true():
    """
    Generates a deterministic Photon regtest bech32m address (segwit v1 output) that
    ...
    assert_equal(address, 'rpho1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsnqpxsl')
