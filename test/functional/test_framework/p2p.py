...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbc\xb4\xd2",   # Photon mainnet (byte 2 is 0xbc, not 0xbe like Blakecoin)
    "testnet3": b"\x0b\x11\x09\x08",  # Photon testnet
    "regtest": b"\xfa\xbf\xb5\xda",   # Photon regtest (matches Bitcoin/Blakecoin regtest convention)
    "signet": b"\x54\xd2\x6f\xbd",    # Photon signet (developer-only, defaults like Bitcoin)
}
