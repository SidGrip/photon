...
"""Photon test framework primitive and message structures
...
COIN = 100000000  # 1 PHO in satoshis
MAX_MONEY = 90000000000 * COIN
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += struct.pack("<i", 0)  # Photon Core ignores version field. Set it to 0.
