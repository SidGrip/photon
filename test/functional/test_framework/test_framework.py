...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def setup(self):
        ...
        fname_bitcoind = preferred_binary_path("photond", "bitcoind")
        fname_bitcoincli = preferred_binary_path("photon-cli", "bitcoin-cli")
        fname_bitcoinutil = preferred_binary_path("photon-util", "bitcoin-util")
    ...
    def _initialize_chain(self):
        ...
        with open(cache_lock, "a+", encoding="utf8") as lockfile:
            ...
            if rebuild_cache:
                ...
                # Set mocktime just beyond Photon regtest's 2*spacing window so
                # the first post-genesis block drops to powLimit difficulty. After
                # that, Photon regtest keeps the easy target while mocktime
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain, self.disable_autoconnect)  # Overwrite port/rpcport in photon.conf
