...
BLAKECOIN_REGTEST_POW_LIMIT_BITS = "207fffff"
BLAKECOIN_REGTEST_TARGET_SPACING = 3 * 60
...
class SegWitTest(BitcoinTestFramework):
    ...
    def build_next_block(self):
        ...
        if tip_header["bits"] != BLAKECOIN_REGTEST_POW_LIMIT_BITS:
            block_time = max(block_time, tip_header["time"] + 2 * BLAKECOIN_REGTEST_TARGET_SPACING + 1)
