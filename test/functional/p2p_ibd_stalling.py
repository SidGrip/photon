...
class P2PIBDStallingTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        blocks = []
        height = 1
        # Blakecoin regtest inherits the genesis target until a block is more than
        ...
        # Wait until 1023 blocks are received. Blakecoin's block payload sizes differ from
