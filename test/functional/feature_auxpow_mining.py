...
"""Test Photon AuxPoW mining workflow and work-cache behaviour."""
...
class AuxpowMiningWorkflowTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Photon address", node0.createauxblock, "not-a-photon-address")

        self.log.info("createauxblock returns Photon-shaped work")
        start_height = node0.getblockcount()
        work0 = node0.createauxblock(address0)
        assert_equal(work0["chainid"], 2)
