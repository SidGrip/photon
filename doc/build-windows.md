...
Below are some notes on how to build Photon Core for Windows.
...
way. This will install to `c:\workspace\photon`, for example:

    make install DESTDIR=/mnt/c/workspace/photon
