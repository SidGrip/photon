...
Encoding=UTF-8
Name=Photon
Comment=Photon P2P Cryptocurrency
Comment[fr]=Photon, monnaie virtuelle cryptographique pair à pair
Comment[tr]=Photon, eşten eşe kriptografik sanal para birimi
Exec=photon-qt %u
Terminal=false
Type=Application
Icon=bitcoin128
MimeType=x-scheme-handler/photon;
